...
urlpatterns = [
    ...
    path('application/<int:pk>/', AdoptionApplicationDetailView.as_view(), name='application_detail'),
    path('application/new/', AdoptionApplicationCreateView.as_view(), name='adoption_application_create'),
    path('application/<int:pk>/edit/', AdoptionApplicationUpdateView.as_view(), name='adoption_application_update'),
    path('application/<int:pk>/delete/', AdoptionApplicationDeleteView.as_view(), name='adoption_application_delete'),
